type StatsCompaniesIconProps = {
  className?: string;
  width?: number;
  height?: number;
};

export default function StatsCompaniesIcon({
  className,
  width = 65,
  height = 65,
}: StatsCompaniesIconProps) {
  return (
    <svg
      width={width}
      height={height}
      ...
      className={className}
    >
      <g clipPath="url(#clip0_3741_33602)">
        <path
