"""
Схемы для API испанских компаний
"""
...
class EsActivityStatus(str, Enum):
    ACTIVE = "ACTIVE"
    DISSOLVED = "DISSOLVED"
...
class EsRegisteredOffice(BaseModel):
...
class EsAddress(BaseModel):
    registered_office: Optional[EsRegisteredOffice] = Field(
...
class EsNace(BaseModel):
    code: Optional[str] = None
    description: Optional[str] = None


class EsNaics(BaseModel):
    code: Optional[str] = None
    description: Optional[str] = None


class EsSic(BaseModel):
    code: Optional[str] = None
    description: Optional[str] = None


class EsInternationalClassification(BaseModel):
    nace: Optional[EsNace] = None
    naics: Optional[EsNaics] = None
    sic: Optional[EsSic] = None
...
# ============================================================================
# Основная модель EsAdvanced
# ============================================================================

class EsAdvanced(BaseModel):
...
class SpainApiResponse(BaseModel):
    data: Optional[List[EsAdvanced]] = None
