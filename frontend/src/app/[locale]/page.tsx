...
export async function generateMetadata({
  ...
  return {
    ...
    alternates: {
      canonical: `https://safelogist.net/${locale}`,
      languages: {
        'ru': 'https://safelogist.net/ru',
        'en': 'https://safelogist.net/en',
        'uk': 'https://safelogist.net/uk',
        'ro': 'https://safelogist.net/ro',
      },
    },
    openGraph: {
      title: meta.title,
      description: meta.description,
      url: `https://safelogist.net/${locale}`,
      siteName: 'SafeLogist',
      locale: locale,
      type: 'website',
    },
